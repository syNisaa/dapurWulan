                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body h-100">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <textarea class="form-control" class="deskripsi" name="deskripsi" rows="5" value="" placeholder="Textarea">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                                                @error('product')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <input type="number" name="harga" class="form-control"
                                                    placeholder="input here" value="{{ old('harga', $produk->harga) }}"><br>
                                                @error('product')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
